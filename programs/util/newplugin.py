...
target_link_libraries( {plugin_provider}_{plugin_name} dpay_app dpay_chain dpay_protocol )
...
{{
   public:
      {plugin_name}_api( const dpay::app::api_context& ctx );
...
class {plugin_name}_plugin : public dpay::app::plugin
{{
   public:
      {plugin_name}_plugin( dpay::app::application* app );
...
{{
   public:
      {plugin_name}_api_impl( dpay::app::application& _app );
...
{plugin_name}_api_impl::{plugin_name}_api_impl( dpay::app::application& _app ) : app( _app )
{{}}
...
{plugin_name}_api::{plugin_name}_api( const dpay::app::api_context& ctx )
{{
...
{{
   public:
      {plugin_name}_plugin_impl( dpay::app::application& app );
...
{plugin_name}_plugin_impl::{plugin_name}_plugin_impl( dpay::app::application& app )
  : _app(app) {{}}
...
{plugin_name}_plugin::{plugin_name}_plugin( dpay::app::application* app )
   : plugin(app)
{{
...
def main(argv):
    ...
    parser.add_argument("provider", help="Name of plugin provider (dPay for plugins developed by dPay Labs)")
