...
int main(int argc, char** argv) {
   dpay::plugin::initialize_plugin_factories();
   ...
   try {
      ...
      std::cerr << "------------------------------------------------------\n\n";
      std::cerr << "        STARTING DPAY JEFFERSON DEV NETWORK\n\n";
      std::cerr << "------------------------------------------------------\n";
      ...
      std::cerr << "------------------------------------------------------\n";
      auto initminer_private_key = graphene::utilities::key_to_wif( DPAY_INIT_PRIVATE_KEY );
      std::cerr << "Genesis Public Key: " << DPAY_INIT_PUBLIC_KEY_STR << "\n";
      ...
      bpo::options_description app_options("dPay Daemon");
      bpo::options_description cfg_options("dPay Daemon");
      app_options.add_options()
            ("help,h", "Print this help message and exit.")
            ("data-dir,d", bpo::value<boost::filesystem::path>()->default_value("witness_node_data_dir"), "Directory containing databases, configuration file, etc.")
            ("version,v", "Print dpayd version and exit.")
            ;

      bpo::variables_map options;

      for( const std::string& plugin_name : dpay::plugin::get_available_plugins() )
         node->register_abstract_plugin( dpay::plugin::create_plugin( plugin_name, node ) );
      ...
      {
         std::cout << "dpay_blockchain_version: " << fc::string( DPAY_BLOCKCHAIN_VERSION ) << "\n";
         std::cout << "dpay_git_revision:       " << fc::string( graphene::utilities::git_revision_sha ) << "\n";
