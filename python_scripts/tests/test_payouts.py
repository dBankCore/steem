...
def main( ):
   ...
   parser = ArgumentParser( description='Run a dpayd debug node on an existing chain, trigger a hardfork' \
...
def run_dpayd_tests( debug_node ):
   ...
   try:
      ...
      rpc = DPayNodeRPC( 'ws://127.0.0.1:8095', '', '' )
