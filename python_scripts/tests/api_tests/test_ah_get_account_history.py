...
"""
  Usage: __name__ jobs url1 url2 [working_dir [accounts_file]]
    Example: script_name 4 http://127.0.0.1:1776 http://127.0.0.1:1777 [get_account_history [accounts]]
...
def main():
  if len( sys.argv ) < 4 or len( sys.argv ) > 6:
    ...
    print( "  Example: __name__ 4 http://127.0.0.1:1776 http://127.0.0.1:1777 [get_account_history [accounts]]" )
