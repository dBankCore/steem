...
- [Installing dPay Kennedy Test Network](https://github.com/dpays/dpay/blob/master/doc/install/kennedy/build-from-source.md)
- Currency symbol KEN.
- 10% APR inflation narrowing to 1% APR over 20 years.
- 75% of inflation to "Proof of Brain" social consensus algorithm.
- 15% of inflation to stake holders.
...
- [Installing dPay Jefferson Dev Network](https://github.com/dpays/dpay/blob/master/doc/install/live/build-from-source.md)
