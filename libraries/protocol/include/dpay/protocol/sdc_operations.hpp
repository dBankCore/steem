...
#define SDC_MIN_HARD_CAP_DPAY_UNITS   10000
#define SDC_MIN_SATURATION_DPAY_UNITS 1000
#define SDC_MIN_SOFT_CAP_DPAY_UNITS   1000
...
struct sdc_capped_generation_policy
{
   ...
   sdc_cap_commitment  min_dpay_units_commitment;
   sdc_cap_commitment  hard_cap_dpay_units_commitment;
