...
#define DPAY_CHAIN_ID_NAME "dpaytest"
#define DPAY_CHAIN_ID (fc::sha256::hash(DPAY_CHAIN_ID_NAME))
...
#define DPAY_BLOCKCHAIN_VERSION              ( version(0, 19, 4) )

#define DPAY_INIT_PUBLIC_KEY_STR             "DWB71hoefovfw8xjGiLpxEDBfc2iDJpAVkbR99PZaiLSR8JiYmp6V"
#define DPAY_CHAIN_ID_NAME "dpay"
#define DPAY_CHAIN_ID fc::sha256()
