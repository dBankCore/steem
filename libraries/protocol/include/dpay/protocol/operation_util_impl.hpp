...
//
// Place DPAY_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define DPAY_DEFINE_OPERATION_TYPE( OperationType )                       \
namespace fc {                                                             \
                                                                           \
...
{                                                                          \
   op.visit( dpay::protocol::operation_validate_visitor() );               \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( dpay::protocol::get_required_auth_visitor( active, owner, posting, other ) ); \
}                                                                          \
                                                                           \
} } /* dpay::protocol */
