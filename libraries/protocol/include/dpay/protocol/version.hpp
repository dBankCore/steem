...
/*
 * This class represents the basic versioning scheme of the dPay blockchain.
...
{
   class variant;
   void to_variant( const dpay::protocol::version& v, variant& var );
   void from_variant( const variant& var, dpay::protocol::version& v );

   void to_variant( const dpay::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, dpay::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( dpay::protocol::version, (v_num) )
FC_REFLECT_DERIVED( dpay::protocol::hardfork_version, (dpay::protocol::version), )

FC_REFLECT( dpay::protocol::hardfork_version_vote, (hf_version)(hf_time) )
