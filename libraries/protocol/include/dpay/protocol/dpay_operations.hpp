...
namespace dpay { namespace protocol {
   ...
   {
      FC_ASSERT( permlink.size() < DPAY_MAX_PERMLINK_LENGTH, "permlink is too long" );
    ...
    *  The percent_dpay_dollars may be decreased, but never increased
    *
    */
   ...
   struct chain_properties
   {
      ...
      void validate()const
      {
         FC_ASSERT( account_creation_fee.amount >= DPAY_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= DPAY_MIN_BLOCK_SIZE_LIMIT);
         FC_ASSERT( bbd_interest_rate >= 0 );
         FC_ASSERT( bbd_interest_rate <= DPAY_100_PERCENT );
      }
   };
    ...
    *  The funds are deposited after DPAY_CONVERSION_DELAY
    */
...
FC_REFLECT( dpay::protocol::chain_properties, (account_creation_fee)(maximum_block_size)(bbd_interest_rate) );
...
FC_REFLECT( dpay::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_dpay_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( dpay::protocol::escrow_transfer_operation, (from)(to)(bbd_amount)(dpay_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
...
FC_REFLECT( dpay::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(bbd_amount)(dpay_amount) );
FC_REFLECT( dpay::protocol::challenge_authority_operation, (challenger)(challenged)(require_owner) );
FC_REFLECT( dpay::protocol::prove_authority_operation, (challenged)(require_owner) );
