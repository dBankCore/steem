...
namespace dpay { namespace protocol {
   ...
   struct legacy_chain_properties
   {
       ...
       */
      legacy_dpay_asset account_creation_fee = legacy_dpay_asset::from_amount( DPAY_MIN_ACCOUNT_CREATION_FEE );
   ...
   struct witness_set_properties_operation : public base_operation
   {
      ...
      void get_required_authorities( vector< authority >& a )const
      {
         ...
         if( key_itr != props.end() )
         {
            ...
            a.push_back( authority( 1, DPAY_NULL_ACCOUNT, 1 ) ); // The null account auth is impossible to satisfy
      }
   };
...
FC_REFLECT( dpay::protocol::placeholder_a_operation, );
FC_REFLECT( dpay::protocol::placeholder_b_operation, );
