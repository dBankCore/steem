...
fc::variant_object get_config()
{
   ...
   result["JACKSON_BLOCK_LIMIT"] = JACKSON_BLOCK_LIMIT;
#elif IS_JEFFERSON_NET
   result[ "IS_JEFFERSON_NET" ] = true;
   result["JEFFERSON_BLOCK_LIMIT"] = JEFFERSON_BLOCK_LIMIT;
#elif IS_FRANKLIN_NET
   result[ "IS_FRANKLIN_NET" ] = true;
   result["FRANKLIN_BLOCK_LIMIT"] = FRANKLIN_BLOCK_LIMIT;
#elif IS_KENNEDY_NET
   result[ "IS_KENNEDY_NET" ] = true;
   result["KENNEDY_BLOCK_LIMIT"] = KENNEDY_BLOCK_LIMIT;
#else
