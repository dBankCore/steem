...
// For identifying Jefferson network builds
#ifdef IS_JEFFERSON_NET
   result[ "IS_JEFFERSON_NET" ] = true;
#else
   result[ "IS_JEFFERSON_NET" ] = false;
#endif

// For identifying Jackson network builds
#ifdef IS_JACKSON_NET
   result[ "IS_JACKSON_NET" ] = true;
#else
   result[ "IS_JACKSON_NET" ] = false;
#endif

// For identifying Kennedy network builds
#ifdef IS_KENNEDY_NET
   result[ "IS_KENNEDY_NET" ] = true;
#else
   result[ "IS_KENNEDY_NET" ] = false;
#endif

// For identifying Franklin network builds
#ifdef IS_FRANKLIN_NET
   result[ "IS_FRANKLIN_NET" ] = true;
#else
   result[ "IS_FRANKLIN_NET" ] = false;
#endif

// For identifying custom/private network builds
#ifdef IS_TEST_NET
