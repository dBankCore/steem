...
#ifndef DPAY_SMT_TEST_SPACE_ID
#define DPAY_SMT_TEST_SPACE_ID 13
#endif

enum smt_test_object_types
{
   smt_token_object_type = ( DPAY_SMT_TEST_SPACE_ID << 8 )
};
...
FC_REFLECT( dpay::plugins::smt_test::smt_token_object,
   (id)
   (control_account)
   (decimal_places)
   (max_supply)
...
CHAINBASE_SET_INDEX_TYPE( dpay::plugins::smt_test::smt_token_object, dpay::plugins::smt_test::smt_token_index )
