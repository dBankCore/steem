...
FC_REFLECT_ENUM( dpay::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( dpay::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( dpay::follow::follow_object, dpay::follow::follow_index )

FC_REFLECT( dpay::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( dpay::follow::feed_object, dpay::follow::feed_index )

FC_REFLECT( dpay::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( dpay::follow::blog_object, dpay::follow::blog_index )

FC_REFLECT( dpay::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( dpay::follow::reputation_object, dpay::follow::reputation_index )

FC_REFLECT( dpay::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( dpay::follow::follow_count_object, dpay::follow::follow_count_index )

FC_REFLECT( dpay::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( dpay::follow::blog_author_stats_object, dpay::follow::blog_author_stats_index );
