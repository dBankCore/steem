...
#include <dpay/follow/follow_objects.hpp>
...
FC_REFLECT( dpay::follow::feed_entry, (author)(permlink)(reblog_by)(reblog_on)(entry_id) );
FC_REFLECT( dpay::follow::comment_feed_entry, (comment)(reblog_by)(reblog_on)(entry_id) );
FC_REFLECT( dpay::follow::blog_entry, (author)(permlink)(blog)(reblog_on)(entry_id) );
FC_REFLECT( dpay::follow::comment_blog_entry, (comment)(blog)(reblog_on)(entry_id) );
FC_REFLECT( dpay::follow::account_reputation, (account)(reputation) );
FC_REFLECT( dpay::follow::follow_api_obj, (follower)(following)(what) );
FC_REFLECT( dpay::follow::follow_count_api_obj, (account)(follower_count)(following_count) );

FC_API( dpay::follow::follow_api,
   (get_followers)
   (get_following)
   (get_follow_count)
   (get_feed_entries)
