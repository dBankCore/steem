...
FC_REFLECT( dpay::follow::follow_operation, (follower)(following)(what) )
FC_REFLECT( dpay::follow::reblog_operation, (account)(author)(permlink) )

DECLARE_OPERATION_TYPE( dpay::follow::follow_plugin_operation )

FC_REFLECT_TYPENAME( dpay::follow::follow_plugin_operation )
