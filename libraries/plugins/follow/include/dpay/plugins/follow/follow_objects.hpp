...
#ifndef DPAY_FOLLOW_SPACE_ID
#define DPAY_FOLLOW_SPACE_ID 8
#endif

enum follow_plugin_object_type
{
   follow_object_type            = ( DPAY_FOLLOW_SPACE_ID << 8 ),
   feed_object_type              = ( DPAY_FOLLOW_SPACE_ID << 8 ) + 1,
   reputation_object_type        = ( DPAY_FOLLOW_SPACE_ID << 8 ) + 2,
   blog_object_type              = ( DPAY_FOLLOW_SPACE_ID << 8 ) + 3,
   follow_count_object_type      = ( DPAY_FOLLOW_SPACE_ID << 8 ) + 4,
   blog_author_stats_object_type = ( DPAY_FOLLOW_SPACE_ID << 8 ) + 5
};
...
FC_REFLECT( dpay::plugins::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
