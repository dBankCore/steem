...
)
{
   ...
   dpay::chain::public_key_type debug_public_key;
   if( debug_key != "" )
   {
   ...
   dpay::chain::database& db = database();
   ...
   while( produced < count )
   {
      ...
      dpay::chain::public_key_type scheduled_key = scheduled_witness.signing_key;
      if( debug_key != "" )
      {
...
DPAY_DEFINE_PLUGIN( debug_node, dpay::plugin::debug_node::debug_node_plugin )
