...
FC_REFLECT( dpay::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( dpay::account_by_key::key_lookup_object, dpay::account_by_key::key_lookup_index )
