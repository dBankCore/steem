...
#ifndef DPAY_ACCOUNT_BY_KEY_SPACE_ID
#define DPAY_ACCOUNT_BY_KEY_SPACE_ID 11
#endif

enum account_by_key_object_types
{
   key_lookup_object_type = ( DPAY_ACCOUNT_BY_KEY_SPACE_ID << 8 )
};
...
FC_REFLECT( dpay::plugins::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( dpay::plugins::account_by_key::key_lookup_object, dpay::plugins::account_by_key::key_lookup_index )
