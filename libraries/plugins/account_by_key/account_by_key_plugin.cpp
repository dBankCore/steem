#include <dpay/account_by_key/account_by_key_plugin.hpp>
#include <dpay/account_by_key/account_by_key_objects.hpp>
...
namespace dpay { namespace account_by_key {
   ...
   void operator()( const hardfork_operation& op )const
   {
      if( op.hardfork_id == DPAY_HARDFORK_0_9 )
      {
         ...
         for( const std::string& acc : hardfork9::get_compromised_accounts() )
         {
            ...
            {
               o.key = public_key_type( "DWB5BykoEiBofELY5ocVrbjwj48PJybpG6ZCHxLaY7fzEKP8BwXsQ" );
...
account_by_key_plugin::account_by_key_plugin( dpay::app::application* app )
...
DPAY_DEFINE_PLUGIN( account_by_key, dpay::account_by_key::account_by_key_plugin )
