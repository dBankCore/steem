...
DPAY_DEFINE_PLUGIN_EVALUATOR( rc_plugin, rc_plugin_operation, delegate_to_pool_operation );
DPAY_DEFINE_PLUGIN_EVALUATOR( rc_plugin, rc_plugin_operation, delegate_drc_from_pool_operation );

} } } // dpay::plugins::rc

FC_REFLECT( dpay::plugins::rc::delegate_to_pool_operation,
   (from_account)
   (to_pool)
   (amount)
   )
FC_REFLECT( dpay::plugins::rc::delegate_drc_from_pool_operation,
   (from_pool)
   (to_account)
   (mana_change)
   (drc_max_mana)
...
DPAY_DECLARE_OPERATION_TYPE( dpay::plugins::rc::rc_plugin_operation )
FC_REFLECT_TYPENAME( dpay::plugins::rc::rc_plugin_operation )
