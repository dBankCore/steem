...
using dpay::chain::util::rd_decay_params;
using dpay::chain::util::rd_dynamics_params;
using dpay::chain::util::rd_compute_pool_decay;
...
FC_REFLECT( dpay::plugins::rc::rc_price_curve_params, (coeff_a)(coeff_b)(shift) )
FC_REFLECT( dpay::plugins::rc::rc_resource_params, (resource_dynamics_params)(price_curve_params) )
