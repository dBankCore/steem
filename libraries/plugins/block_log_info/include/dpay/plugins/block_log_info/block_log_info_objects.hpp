...
#ifndef DPAY_BLOCK_LOG_INFO_SPACE_ID
#define DPAY_BLOCK_LOG_INFO_SPACE_ID 14
#endif

enum block_log_info_object_types
{
   block_log_hash_state_object_type      = ( DPAY_BLOCK_LOG_INFO_SPACE_ID << 8 )    ,
   block_log_pending_message_object_type = ( DPAY_BLOCK_LOG_INFO_SPACE_ID << 8 ) + 1,
};
