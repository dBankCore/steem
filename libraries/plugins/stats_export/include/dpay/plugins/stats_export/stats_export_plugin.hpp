...
#define DPAY_STATS_EXPORT_PLUGIN_NAME "stats_export"
...
class stats_export_plugin : public appbase::plugin< stats_export_plugin >
{
   public:
      ...
      APPBASE_PLUGIN_REQUIRES(
         (dpay::plugins::block_data_export::block_data_export_plugin)
         (dpay::plugins::chain::chain_plugin)
      )

      static const std::string& name() { static std::string name = DPAY_STATS_EXPORT_PLUGIN_NAME; return name; }
