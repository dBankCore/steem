...
FC_REFLECT( dpay::plugins::database_api::list_sbd_conversion_requests_args,
   (start)(limit)(order) )

FC_REFLECT( dpay::plugins::database_api::list_sbd_conversion_requests_return,
   (requests) )

FC_REFLECT( dpay::plugins::database_api::find_sbd_conversion_requests_args,
   (account) )
