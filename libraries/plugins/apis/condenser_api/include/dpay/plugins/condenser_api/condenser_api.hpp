...
#include <dpay/plugins/account_by_key_api/account_by_key_api.hpp>
#include <dpay/plugins/network_broadcast_api/network_broadcast_api.hpp>
#include <dpay/plugins/tags_api/tags_api.hpp>
...
struct api_account_object
{
   api_account_object( const database_api::api_account_object& a ) :
      ...
      bbd_balance( legacy_asset::from_asset( a.bbd_balance ) ),
      bbd_seconds( a.bbd_seconds ),
      bbd_seconds_last_update( a.bbd_seconds_last_update ),
      bbd_last_interest_payment( a.bbd_last_interest_payment ),
      savings_bbd_balance( legacy_asset::from_asset( a.savings_bbd_balance ) ),
      savings_bbd_seconds( a.savings_bbd_seconds ),
      savings_bbd_seconds_last_update( a.savings_bbd_seconds_last_update ),
      savings_bbd_last_interest_payment( a.savings_bbd_last_interest_payment ),
      savings_withdraw_requests( a.savings_withdraw_requests ),
      reward_bbd_balance( legacy_asset::from_asset( a.reward_bbd_balance ) ),
      reward_dpay_balance( legacy_asset::from_asset( a.reward_dpay_balance ) ),
      reward_vesting_balance( legacy_asset::from_asset( a.reward_vesting_balance ) ),
      reward_vesting_dpay( legacy_asset::from_asset( a.reward_vesting_dpay ) ),
   ...
   legacy_asset      bbd_balance;
   uint128_t         bbd_seconds;
   time_point_sec    bbd_seconds_last_update;
   time_point_sec    bbd_last_interest_payment;

   legacy_asset      savings_bbd_balance;
   uint128_t         savings_bbd_seconds;
   time_point_sec    savings_bbd_seconds_last_update;
   time_point_sec    savings_bbd_last_interest_payment;

   uint8_t           savings_withdraw_requests = 0;

   legacy_asset      reward_bbd_balance;
   legacy_asset      reward_dpay_balance;
   legacy_asset      reward_vesting_balance;
   legacy_asset      reward_vesting_dpay;
...
struct extended_dynamic_global_properties
{
   ...
   extended_dynamic_global_properties( const database_api::api_dynamic_global_property_object& o ) :
      ...
      current_bbd_supply( legacy_asset::from_asset( o.current_bbd_supply ) ),
      confidential_bbd_supply( legacy_asset::from_asset( o.confidential_bbd_supply ) ),
      total_vesting_fund_dpay( legacy_asset::from_asset( o.total_vesting_fund_dpay ) ),
      total_vesting_shares( legacy_asset::from_asset( o.total_vesting_shares ) ),
      total_reward_fund_dpay( legacy_asset::from_asset( o.total_reward_fund_dpay ) ),
      ...
      pending_rewarded_vesting_dpay( legacy_asset::from_asset( o.pending_rewarded_vesting_dpay ) ),
      bbd_interest_rate( o.bbd_interest_rate ),
      bbd_print_rate( o.bbd_print_rate ),
   ...
   legacy_asset      current_bbd_supply;
   legacy_asset      confidential_bbd_supply;
   legacy_asset      total_vesting_fund_dpay;
   legacy_asset      total_vesting_shares;
   legacy_asset      total_reward_fund_dpay;
   fc::uint128       total_reward_shares2;
   legacy_asset      pending_rewarded_vesting_shares;
   legacy_asset      pending_rewarded_vesting_dpay;

   uint16_t          bbd_interest_rate = 0;
   uint16_t          bbd_print_rate = DPAY_100_PERCENT;
   ...
   uint32_t          vote_power_reserve_rate = DPAY_INITIAL_VOTE_POWER_RATE;
...
struct api_witness_object
{
   ...
   api_witness_object( const database_api::api_witness_object& w ) :
      ...
      props( w.props ),
      bbd_exchange_rate( w.bbd_exchange_rate ),
      last_bbd_exchange_update( w.last_bbd_exchange_update ),
      votes( w.votes ),
   ...
   legacy_price            bbd_exchange_rate;
   ...
   time_point_sec          hardfork_time_vote = DPAY_GENESIS_TIME;
};
...
struct api_witness_schedule_object
{
   ...
   uint8_t                       max_voted_witnesses           = DPAY_MAX_VOTED_WITNESSES_HF0;
   uint8_t                       max_miner_witnesses           = DPAY_MAX_MINER_WITNESSES_HF0;
   uint8_t                       max_runner_witnesses          = DPAY_MAX_RUNNER_WITNESSES_HF0;
   uint8_t                       hardfork_required_witnesses   = DPAY_HARDFORK_REQUIRED_WITNESSES;
};
...
struct api_escrow_object
{
   ...
   api_escrow_object( const database_api::api_escrow_object& e ) :
      ...
      bbd_balance( legacy_asset::from_asset( e.bbd_balance ) ),
      dpay_balance( legacy_asset::from_asset( e.dpay_balance ) ),
...
struct discussion
{
   ...
   discussion( const tags::discussion& d ) :
      ...
      percent_dpay_dollars( d.percent_dpay_dollars ),
   ...
   uint16_t          percent_dpay_dollars = 0;
   ...
   string                        root_title;
   legacy_asset                  pending_payout_value; ///< bbd
   legacy_asset                  total_pending_payout_value; ///< bbd including replies
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v )
      :blockchain_version( bc_v ), dpay_revision( s_v ), fc_revision( fc_v ) {}
...
struct ticker
{
   ...
   ticker( const market_history::get_ticker_return& t ) :
      ...
      dpay_volume( legacy_asset::from_asset( t.dpay_volume ) ),
      bbd_volume( legacy_asset::from_asset( t.bbd_volume ) )
   {}
   ...
   legacy_asset   dpay_volume;
   legacy_asset   bbd_volume;
};
...
struct volume
{
   ...
   volume( const market_history::get_volume_return& v ) :
      dpay_volume( legacy_asset::from_asset( v.dpay_volume ) ),
      bbd_volume( legacy_asset::from_asset( v.bbd_volume ) )
   {}
...
FC_REFLECT_DERIVED( dpay::plugins::condenser_api::extended_limit_order, (dpay::plugins::database_api::api_limit_order_object),
            (real_price)(rewarded) )
...
FC_REFLECT( dpay::plugins::condenser_api::api_account_object,
             ...
             (balance)
             (savings_balance)
             (bbd_balance)(bbd_seconds)(bbd_seconds_last_update)(bbd_last_interest_payment)
             (savings_bbd_balance)(savings_bbd_seconds)(savings_bbd_seconds_last_update)(savings_bbd_last_interest_payment)(savings_withdraw_requests)
             (reward_bbd_balance)(reward_dpay_balance)(reward_vesting_balance)(reward_vesting_dpay)
...
FC_REFLECT( dpay::plugins::condenser_api::extended_dynamic_global_properties,
            ...
            (virtual_supply)(current_supply)(confidential_supply)(current_bbd_supply)(confidential_bbd_supply)
...
FC_REFLECT( dpay::plugins::condenser_api::legacy_chain_properties,
...
FC_REFLECT( dpay::plugins::condenser_api::api_witness_object,
             ...
             (props)
             (bbd_exchange_rate)(last_bbd_exchange_update)
             (last_work)
             (running_version)
...
FC_REFLECT( dpay::plugins::condenser_api::api_escrow_object,
             ...
             (bbd_balance)(dpay_balance)(pending_fee)
...
FC_REFLECT( dpay::plugins::condenser_api::discussion,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_dpay_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
