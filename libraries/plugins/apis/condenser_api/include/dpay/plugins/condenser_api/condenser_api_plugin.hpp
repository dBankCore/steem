...
#define DPAY_CONDENSER_API_PLUGIN_NAME "condenser_api"
...
{
public:
   APPBASE_PLUGIN_REQUIRES( (dpay::plugins::json_rpc::json_rpc_plugin)(dpay::plugins::database_api::database_api_plugin) )

   condenser_api_plugin();
   virtual ~condenser_api_plugin();

   static const std::string& name() { static std::string name = DPAY_CONDENSER_API_PLUGIN_NAME; return name; }
