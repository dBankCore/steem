...
using dpay::chain::share_type;
using dpay::chain::asset;
...
FC_REFLECT( dpay::plugins::market_history::get_ticker_return,
            (latest)(lowest_ask)(highest_bid)(percent_change)(dpay_volume)(bbd_volume) )

FC_REFLECT( dpay::plugins::market_history::get_volume_return,
            (dpay_volume)(bbd_volume) )

FC_REFLECT( dpay::plugins::market_history::order,
            (order_price)(real_price)(dpay)(bbd)(created) )

FC_REFLECT( dpay::plugins::market_history::get_order_book_args,
            (limit) )

FC_REFLECT( dpay::plugins::market_history::get_order_book_return,
            (bids)(asks) )

FC_REFLECT( dpay::plugins::market_history::market_trade,
            (date)(current_pays)(open_pays) )

FC_REFLECT( dpay::plugins::market_history::get_trade_history_args,
            (start)(end)(limit) )

FC_REFLECT( dpay::plugins::market_history::get_trade_history_return,
            (trades) )

FC_REFLECT( dpay::plugins::market_history::get_recent_trades_args,
            (limit) )

FC_REFLECT( dpay::plugins::market_history::get_market_history_args,
            (bucket_seconds)(start)(end) )

FC_REFLECT( dpay::plugins::market_history::get_market_history_return,
            (buckets) )

FC_REFLECT( dpay::plugins::market_history::get_market_history_buckets_return,
            (bucket_sizes) )
