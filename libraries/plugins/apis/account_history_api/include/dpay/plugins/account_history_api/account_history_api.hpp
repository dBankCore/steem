...
{
   dpay::protocol::transaction_id_type id;
};

typedef dpay::protocol::annotated_signed_transaction get_transaction_return;
...
FC_REFLECT( dpay::plugins::account_history::api_operation_object,
   (trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(op) )

FC_REFLECT( dpay::plugins::account_history::get_ops_in_block_args,
   (block_num)(only_virtual) )

FC_REFLECT( dpay::plugins::account_history::get_ops_in_block_return,
   (ops) )

FC_REFLECT( dpay::plugins::account_history::get_transaction_args,
   (id) )

FC_REFLECT( dpay::plugins::account_history::get_account_history_args,
   (account)(start)(limit) )

FC_REFLECT( dpay::plugins::account_history::get_account_history_return,
   (history) )

FC_REFLECT( dpay::plugins::account_history::enum_virtual_ops_args,
   (block_range_begin)(block_range_end) )

FC_REFLECT( dpay::plugins::account_history::enum_virtual_ops_return,
