...
#define DPAY_ACCOUNT_BY_KEY_API_PLUGIN_NAME "account_by_key_api"
...
public:
   APPBASE_PLUGIN_REQUIRES(
      (dpay::plugins::account_by_key::account_by_key_plugin)
   ...
   static const std::string& name() { static std::string name = DPAY_ACCOUNT_BY_KEY_API_PLUGIN_NAME; return name; }
