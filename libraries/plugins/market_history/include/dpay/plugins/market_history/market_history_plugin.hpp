...
// time.
//
#ifndef DPAY_MARKET_HISTORY_SPACE_ID
#define DPAY_MARKET_HISTORY_SPACE_ID 7
#endif

#ifndef DPAY_MARKET_HISTORY_PLUGIN_NAME
#define DPAY_MARKET_HISTORY_PLUGIN_NAME "market_history"
#endif
...
{
   bucket_object_type        = ( DPAY_MARKET_HISTORY_SPACE_ID << 8 ),
   order_history_object_type = ( DPAY_MARKET_HISTORY_SPACE_ID << 8 ) + 1
};
...
class market_history_plugin : public plugin< market_history_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = DPAY_MARKET_HISTORY_PLUGIN_NAME; return name; }
