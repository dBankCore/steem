...
#ifndef DPAY_WITNESS_SPACE_ID
#define DPAY_WITNESS_SPACE_ID 12
#endif

enum witness_plugin_object_type
{
   account_bandwidth_object_type = ( DPAY_WITNESS_SPACE_ID << 8 ),
   content_edit_lock_object_type = ( DPAY_WITNESS_SPACE_ID << 8 ) + 1,
   reserve_ratio_object_type     = ( DPAY_WITNESS_SPACE_ID << 8 ) + 2,
};
