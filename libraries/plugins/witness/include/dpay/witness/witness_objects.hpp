...
FC_REFLECT_ENUM( dpay::witness::bandwidth_type, (post)(forum)(market) )

FC_REFLECT( dpay::witness::account_bandwidth_object,
            (id)(account)(type)(average_bandwidth)(lifetime_bandwidth)(last_bandwidth_update) )
CHAINBASE_SET_INDEX_TYPE( dpay::witness::account_bandwidth_object, dpay::witness::account_bandwidth_index )

FC_REFLECT( dpay::witness::content_edit_lock_object,
            (id)(account)(lock_time) )
CHAINBASE_SET_INDEX_TYPE( dpay::witness::content_edit_lock_object, dpay::witness::content_edit_lock_index )

FC_REFLECT( dpay::witness::reserve_ratio_object,
            (id)(average_block_size)(current_reserve_ratio)(max_virtual_bandwidth) )
CHAINBASE_SET_INDEX_TYPE( dpay::witness::reserve_ratio_object, dpay::witness::reserve_ratio_index )
