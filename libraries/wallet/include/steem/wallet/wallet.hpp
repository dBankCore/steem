...
class wallet_api
{
   public:
       ...
       *
       *  @param creator The account creating the new account
       *  @param steem_fee The amount of the fee to be paid with BEX
      ...
      /**
       * Transfer funds from one account to another. BEX and SBD can be transferred.
       *
      ...
      /**
       * Transfer funds from one account to another using escrow. BEX and SBD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       ...
       * @param steem_amount The amount of BEX to transfer
       ...
       * @param steem_amount The amount of BEX that will be released
       * @param broadcast true if you wish to broadcast the transaction
       */
      ...
      /**
       *  This method will convert SBD to BEX at the current_median_history price one
      ...
      /**
       * A witness can public a price feed for the BEX:SBD market. The median price feed is used
       * to process conversion requests from SBD to BEX.
       *
      ...
      /**
       * Gets the current order book for BEX:SBD
       *
       ...
       *  @param amount_to_sell The amount of either SBD or BEX you wish to sell
