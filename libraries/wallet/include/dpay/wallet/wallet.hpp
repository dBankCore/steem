...
#include <dpay/follow/follow_plugin.hpp>
#include <dpay/app/dpay_api_objects.hpp>
...
using dpay::app::discussion;
using namespace dpay::private_message;
...
class wallet_api
{
   public:
       ...
       *  @param broadcast true if you wish to broadcast the transaction
       */
      annotated_signed_transaction create_account_delegated( string creator, asset dpay_fee, asset delegated_vests, string new_account_name, string json_meta, bool broadcast );
      ...
      /**
       * Transfer funds from one account to another. BEX and BBD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       * @param amount The funds being transferred. i.e. "100.000 BEX"
      ...
      /**
       * Transfer funds from one account to another using escrow. BEX and BBD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       * @param agent The account acting as the agent in case of dispute
       * @param escrow_id A unique id for the escrow transfer. (from, escrow_id) must be a unique pair
       * @param bbd_amount The amount of BBD to transfer
       * @param dpay_amount The amount of BEX to transfer
       ...
       * @param escrow_id A unique id for the escrow transfer
       * @param bbd_amount The amount of BBD that will be released
       * @param dpay_amount The amount of BEX that will be released
       * @param broadcast true if you wish to broadcast the transaction
       */
      ...
      /**
       * Transfer BEX into a vesting fund represented by vesting shares (VESTS). VESTS are required to vesting
       * for a minimum of one coin year and can be withdrawn once a week over a two year withdraw period.
       * VESTS are protected against dilution up until 90% of BEX is vesting.
       *
       * @param from The account the BEX is coming from
       * @param to The account getting the VESTS
       * @param amount The amount of BEX to vest i.e. "100.00 BEX"
       * @param broadcast true if you wish to broadcast the transaction
       */
      ...
      /**
       *  This method will convert BBD to BEX at the current_median_history price one
       *  week from the time it is executed. This method depends upon there being a valid price feed.
       *
       *  @param from The account requesting conversion of its BBD i.e. "1.000 BBD"
       *  @param amount The amount of BBD to convert
       *  @param broadcast true if you wish to broadcast the transaction
       */
      annotated_signed_transaction convert_bbd( string from, asset amount, bool broadcast = false );
       ...
       *                       operations defined in `dpay/chain/operations.hpp`
      ...
      /**
       * Gets the current order book for BEX:BBD
       *
       ...
       *  @param amount_to_sell The amount of either BBD or BEX you wish to sell
      ...
      /**
       * Vote on a comment to be paid BEX
       *
       ...
       * BEX Power. Until the challenged proves their active key, all posting rights are revoked.
       *
      ...
      annotated_signed_transaction claim_reward_balance( string account, asset reward_dpay, asset reward_bbd, asset reward_vests, bool broadcast );
};
