...
FC_REFLECT( dpay::utilities::console_appender_args, (appender)(stream) )
FC_REFLECT( dpay::utilities::file_appender_args, (appender)(file) )
FC_REFLECT( dpay::utilities::logger_args, (name)(level)(appender) )
