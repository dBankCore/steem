#pragma once
#include <dpay/app/applied_operation.hpp>
...
namespace dpay { namespace app {
   ...
   struct  discussion : public comment_api_obj {
      ...
      string                      root_title;
      asset                       pending_payout_value; ///< bbd
      asset                       total_pending_payout_value; ///< bbd including replies
      vector<vote_state>          active_votes;
      vector<string>              replies; ///< author/slug mapping
      share_type                  author_reputation = 0;
      asset                       promoted = asset(0, BBD_SYMBOL);
   ...
   struct extended_account : public account_api_obj
   {
      ...
      asset                                   vesting_balance; /// convert vesting_shares to vesting BEX
      share_type                              reputation = 0;
...
FC_REFLECT_DERIVED( dpay::app::extended_account,
                   (dpay::app::account_api_obj),
...
FC_REFLECT( dpay::app::vote_state, (voter)(weight)(rshares)(percent)(reputation)(time) );
FC_REFLECT( dpay::app::account_vote, (authorperm)(weight)(rshares)(percent)(time) );

FC_REFLECT( dpay::app::discussion_index, (category)(trending)(payout)(payout_comments)(trending30)(updated)(created)(responses)(active)(votes)(maturing)(best)(hot)(promoted)(cashout) )
FC_REFLECT( dpay::app::tag_index, (trending) )
FC_REFLECT_DERIVED( dpay::app::discussion, (dpay::app::comment_api_obj), (url)(root_title)(pending_payout_value)(total_pending_payout_value)(active_votes)(replies)(author_reputation)(promoted)(body_length)(reblogged_by)(first_reblogged_by)(first_reblogged_on) )

FC_REFLECT( dpay::app::state, (current_route)(props)(tag_idx)(tags)(content)(accounts)(pow_queue)(witnesses)(discussion_idx)(witness_schedule)(feed_price)(error)(market_data) )

FC_REFLECT_DERIVED( dpay::app::extended_limit_order, (dpay::app::limit_order_api_obj), (real_price)(rewarded) )
FC_REFLECT( dpay::app::order_history_item, (time)(type)(bbd_quantity)(dpay_quantity)(real_price) );
FC_REFLECT( dpay::app::market, (bids)(asks)(history)(price_history)(available_candlesticks)(available_zoom)(current_candlestick)(current_zoom) )
FC_REFLECT( dpay::app::candle_stick, (open_time)(period)(high)(low)(open)(close)(dpay_volume)(dollar_volume) );
