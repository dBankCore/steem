...
{
   public:
      database_api(const dpay::app::api_context& ctx);
      ~database_api();
      ...
      /**
       * @breif Gets the current order book for BEX:BBD market
...
FC_REFLECT( dpay::app::order, (order_price)(real_price)(dpay)(bbd)(created) );
FC_REFLECT( dpay::app::order_book, (asks)(bids) );
FC_REFLECT( dpay::app::scheduled_hardfork, (hf_version)(live_time) );
FC_REFLECT( dpay::app::liquidity_balance, (account)(weight) );
FC_REFLECT( dpay::app::withdraw_route, (from_account)(to_account)(percent)(auto_vest) );

FC_REFLECT( dpay::app::discussion_query, (tag)(filter_tags)(select_tags)(select_authors)(truncate_body)(start_author)(start_permlink)(parent_author)(parent_permlink)(limit) );

FC_REFLECT_ENUM( dpay::app::withdraw_route_type, (incoming)(outgoing)(all) );

FC_API(dpay::app::database_api,
   // Subscriptions
