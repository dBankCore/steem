...
struct comment_api_obj
{
   comment_api_obj( const chain::comment_object& o ):
      ...
      percent_dpay_dollars( o.percent_dpay_dollars ),
...
struct account_api_obj
{
   account_api_obj( const chain::account_object& a, const chain::database& db ) :
      ...
      savings_bbd_balance( a.savings_bbd_balance ),
      ...
      reward_bbd_balance( a.reward_bbd_balance ),
      reward_dpay_balance( a.reward_dpay_balance ),
      reward_vesting_balance( a.reward_vesting_balance ),
      reward_vesting_dpay( a.reward_vesting_dpay ),
   ...
   asset             reward_bbd_balance;
   asset             reward_dpay_balance;
   asset             reward_vesting_balance;
   asset             reward_vesting_dpay;
...
FC_REFLECT( dpay::app::comment_api_obj,
             (id)(author)(permlink)
...
FC_REFLECT( dpay::app::account_api_obj,
...
FC_REFLECT( dpay::app::owner_authority_history_api_obj,
             (id)
             (account)
...
FC_REFLECT( dpay::app::account_recovery_request_api_obj,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( dpay::app::savings_withdraw_api_obj,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( dpay::app::feed_history_api_obj,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( dpay::app::tag_api_obj,
            (name)
            (total_payouts)
            (net_votes)
            (top_posts)
...
FC_REFLECT( dpay::app::witness_api_obj,
             (id)
             (owner)
             (created)
...
FC_REFLECT_DERIVED( dpay::app::signed_block_api_obj, (dpay::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT_DERIVED( dpay::app::dynamic_global_property_api_obj, (dpay::chain::dynamic_global_property_object),
