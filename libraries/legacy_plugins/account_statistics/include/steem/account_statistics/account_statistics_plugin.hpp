...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_sbd = 0;                   ///< BBD paid for author rewards
   share_type           author_rewards_vests = 0;                 ///< VESTS paid for author rewards
   share_type           author_rewards_total_steem_value = 0;     ///< BEX Value of author rewards
   share_type           author_rewards_payout_sbd_value = 0;      ///< BBD Value of author rewards at time of payout
   ...
   share_type           curation_rewards_steem_value = 0;         ///< BEX Value of curation rewards
   share_type           curation_rewards_payout_sbd_value = 0;    ///< BBD Value of curation rewards at time of payout
   ...
   share_type           steem_sent = 0;                           ///< BEX sent from this account
   share_type           steem_received = 0;                       ///< BEX received by this account
   share_type           sbd_sent = 0;                             ///< BBD sent from this account
   share_type           sbd_received = 0;                         ///< BBD received by this account
   uint32_t             sbd_interest_payments = 0;                ///< Number of times interest was paid to BBD
   share_type           sbd_paid_as_interest = 0;                 ///< Amount of BBD paid as interest
   ...
   share_type           steem_vested = 0;                         ///< BEX vested by the account
   ...
   share_type           steem_received_from_withdrawls = 0;       ///< BEX received from this account's vesting withdrawals
   share_type           steem_received_from_routes = 0;           ///< BEX received from another account's vesting withdrawals
   share_type           vests_received_from_routes = 0;           ///< VESTS received from another account's vesting withdrawals
   uint32_t             sbd_conversion_requests_created = 0;      ///< BBD conversion requests created
   share_type           sbd_to_be_converted = 0;                  ///< Amount of BBD to be converted
   uint32_t             sbd_conversion_requests_filled = 0;       ///< BBD conversion requests filled
   share_type           steem_converted = 0;                      ///< Amount of BEX that was converted
   ...
   share_type           limit_order_steem_paid = 0;               ///< BEX paid by limit orders
   share_type           limit_order_steem_received = 0;           ///< BEX received from limit orders
   share_type           limit_order_sbd_paid = 0;                 ///< BBD paid by limit orders
   share_type           limit_order_sbd_received = 0;             ///< BBD received by limit orders
