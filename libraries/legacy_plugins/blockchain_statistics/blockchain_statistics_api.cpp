#include <dpay/blockchain_statistics/blockchain_statistics_api.hpp>
...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( dpay::app::application& app )
            :_app( app ) {}
   ...
   statistics blockchain_statistics_api_impl::get_stats_for_interval( fc::time_point_sec start, fc::time_point_sec end )const
   {
      ...
      const auto& sizes = _app.get_plugin< blockchain_statistics_plugin >( DPAY_BLOCKCHAIN_STATISTICS_PLUGIN_NAME )->get_tracked_buckets();
...
blockchain_statistics_api::blockchain_statistics_api( const dpay::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->dpay_transferred                      += b.dpay_transferred;
   this->bbd_transferred                        += b.bbd_transferred;
   this->bbd_paid_as_interest                   += b.bbd_paid_as_interest;
   ...
   this->bbd_paid_to_authors                    += b.bbd_paid_to_authors;
   ...
   this->dpay_vested                           += b.dpay_vested;
   ...
   this->bbd_conversion_requests_created        += b.bbd_conversion_requests_created;
   this->bbd_to_be_converted                    += b.bbd_to_be_converted;
   this->bbd_conversion_requests_filled         += b.bbd_conversion_requests_filled;
   this->dpay_converted                        += b.dpay_converted;
