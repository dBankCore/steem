...
// time.
//
#ifndef DPAY_BLOCKCHAIN_STATISTICS_SPACE_ID
#define DPAY_BLOCKCHAIN_STATISTICS_SPACE_ID 9
#endif

#ifndef DPAY_BLOCKCHAIN_STATISTICS_PLUGIN_NAME
#define DPAY_BLOCKCHAIN_STATISTICS_PLUGIN_NAME "chain_stats"
#endif
...
{
   bucket_object_type = ( DPAY_BLOCKCHAIN_STATISTICS_SPACE_ID << 8 )
};
...
class blockchain_statistics_plugin : public dpay::app::plugin
{
   public:
      blockchain_statistics_plugin( application* app );
      virtual ~blockchain_statistics_plugin();

      virtual std::string plugin_name()const override { return DPAY_BLOCKCHAIN_STATISTICS_PLUGIN_NAME; }
...
struct bucket_object : public object< bucket_object_type, bucket_object >
{
   ...
   share_type           dpay_transferred = 0;                       ///< BEX transferred from account to account
   share_type           bbd_transferred = 0;                         ///< BBD transferred from account to account
   share_type           bbd_paid_as_interest = 0;                    ///< BBD paid as interest
   ...
   share_type           bbd_paid_to_authors = 0;                     ///< Ammount of BBD paid to authors
   ...
   share_type           liquidity_rewards_paid = 0;                  ///< Ammount of BEX paid to market makers
   uint32_t             transfers_to_vesting = 0;                    ///< Transfers of BEX into VESTS
   share_type           dpay_vested = 0;                            ///< Ammount of BEX vested
   ...
   share_type           vests_withdrawn = 0;                         ///< Ammount of VESTS withdrawn to BEX
...
FC_REFLECT( dpay::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( dpay::blockchain_statistics::bucket_object, dpay::blockchain_statistics::bucket_index )
