...
#include <dpay/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
   public:
      blockchain_statistics_api( const dpay::app::api_context& ctx );
...
FC_REFLECT( dpay::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( dpay::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
