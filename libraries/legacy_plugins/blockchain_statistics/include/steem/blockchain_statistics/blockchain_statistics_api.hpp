...
#include <steem/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
struct statistics
{
   ...
   share_type           steem_transferred = 0;                       ///< BEX transferred from account to account
   share_type           sbd_transferred = 0;                         ///< BBD transferred from account to account
   share_type           sbd_paid_as_interest = 0;                    ///< BBD paid as interest
   ...
   share_type           sbd_paid_to_authors = 0;                     ///< Ammount of BBD paid to authors
   ...
   share_type           steem_vested = 0;                            ///< Ammount of BEX vested
