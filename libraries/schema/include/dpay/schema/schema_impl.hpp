...
#define DPAY_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
DPAY_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define DPAY_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define DPAY_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define DPAY_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
DPAY_DECLARE_SCHEMA_CLASS( false, false )
DPAY_DECLARE_SCHEMA_CLASS(  true, false )
DPAY_DECLARE_SCHEMA_CLASS(  true,  true )
