   ...
   switch( hardfork )
   {
      case DPAY_HARDFORK_0_1:
...
#ifdef IS_TEST_NET
         {
            ...
            string op_msg = "Custom dPay Network: Hardfork applied";
         ...
         {
            custom_operation test_op;
            string op_msg = "dPay Jackson Test Network: Hardfork applied";
            test_op.data = vector< char >( op_msg.begin(), op_msg.end() );
            test_op.required_auths.insert( DPAY_INIT_MINER_NAME );
            operation op = test_op;   // we need the operation object to live to the end of this scope
            operation_notification note( op );
         ...
         {
            custom_operation test_op;
            string op_msg = "dPay Jefferson Test Network: Hardfork applied";
            test_op.data = vector< char >( op_msg.begin(), op_msg.end() );
            test_op.required_auths.insert( DPAY_INIT_MINER_NAME );
            operation op = test_op;   // we need the operation object to live to the end of this scope
            operation_notification note( op );
         ...
         {
            custom_operation test_op;
            string op_msg = "dPay Franklin Test Network: Hardfork applied";
            test_op.data = vector< char >( op_msg.begin(), op_msg.end() );
            test_op.required_auths.insert( DPAY_INIT_MINER_NAME );
            operation op = test_op;   // we need the operation object to live to the end of this scope
            operation_notification note( op );
         ...
         {
            custom_operation test_op;
            string op_msg = "dPay Kennedy Test Network: Hardfork applied";
            test_op.data = vector< char >( op_msg.begin(), op_msg.end() );
            test_op.required_auths.insert( DPAY_INIT_MINER_NAME );
            operation op = test_op;   // we need the operation object to live to the end of this scope
            operation_notification note( op );
