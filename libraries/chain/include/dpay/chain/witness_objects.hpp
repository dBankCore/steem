...
namespace dpay { namespace chain {
   ...
   struct chain_properties
   {
       ...
       * Scaled so that DPAY_ACCOUNT_SUBSIDY_PRECISION represents one account.
       */
       ...
       * Scaled so that 1 << DPAY_RD_DECAY_DENOM_SHIFT represents 100% of accounts
       * expiring.
       */
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         /**
          * This field represents the dPay blockchain version the witness is running.
          */
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, DPAY_MAX_WITNESSES >             current_shuffled_witnesses;
