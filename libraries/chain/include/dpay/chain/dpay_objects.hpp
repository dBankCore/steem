...
namespace dpay { namespace chain {
    ...
    *  1000 BEX or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         int64_t           dpay_volume = 0;
         int64_t           bbd_volume = 0;
         uint128_t         weight = 0;
         ...
         {
            return dpay_volume * bbd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(dpay_volume,bbd_volume) * is_positive();
         }
         ...
         {
            return ( dpay_volume > 0 && bbd_volume > 0 ) ? 1 : 0;
         }
   };
   ...
   typedef multi_index_container<
      ...
      indexed_by<
         ...
         >,
         ordered_unique< tag< by_bbd_balance >,
            composite_key< escrow_object,
               member< escrow_object, asset, &escrow_object::bbd_balance >,
               member< escrow_object, escrow_id_type, &escrow_object::id >
            >,
...
FC_REFLECT_ENUM( dpay::chain::curve_id,
...
FC_REFLECT( dpay::chain::liquidity_reward_balance_object,
             (id)(owner)(dpay_volume)(bbd_volume)(weight)(last_update) )
