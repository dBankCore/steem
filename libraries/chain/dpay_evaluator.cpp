...
void witness_set_properties_evaluator::do_apply( const witness_set_properties_operation& o )
{
   ...
   bool bbd_interest_changed     = false;
   bool account_subsidy_changed  = false;
   bool key_changed              = false;
   bool bbd_exchange_changed     = false;
...
{ try {
   ...
   int64_t max_vote_denom = dgpo.vote_power_reserve_rate * DPAY_VOTE_REGENERATION_SECONDS;
