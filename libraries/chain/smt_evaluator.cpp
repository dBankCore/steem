...
void smt_create_evaluator::do_apply( const smt_create_operation& o )
{
   ...
   FC_ASSERT( dgpo.smt_creation_fee.symbol == BEX_SYMBOL || dgpo.smt_creation_fee.symbol == BBD_SYMBOL,
      "Unexpected internal error - wrong symbol ${s} of SMT creation fee.", ("s", dgpo.smt_creation_fee.symbol) );
   FC_ASSERT( o.smt_creation_fee.symbol == BEX_SYMBOL || o.smt_creation_fee.symbol == BBD_SYMBOL,
   ...
   else
   {
      ...
      if( o.smt_creation_fee.symbol == BEX_SYMBOL )
      {
