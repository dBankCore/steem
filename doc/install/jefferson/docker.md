# Installing dPay's Jefferson Dev Network Node With Docker
We provide instructions for installing dPay's Jefferson dev network node using Docker
...
docker run \
    ...
    --restart unless-stopped dpay/dev
```
