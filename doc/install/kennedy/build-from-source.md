# Build dPay's Kennedy Test Network From Source
...
will build out of the box without further effort:
    ...
    mkdir build
    cd build
    cmake -DCMAKE_BUILD_TYPE=Release -DBUILD_DPAY_KENNEDY=ON ..
    make -j$(nproc) dpayd
...
#### Compile
    ...
    git submodule update --init --recursive
    mkdir build && cd build
    cmake -DBOOST_ROOT="$BOOST_ROOT" -DCMAKE_BUILD_TYPE=Release -DBUILD_DPAY_KENNEDY=ON ..
