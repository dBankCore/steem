# Installing dPay's Jackson Test Network Node With Docker
We provide instructions for installing dPay's Jackson test network node using Docker
...
docker run \
    ...
    --restart unless-stopped dpay/jackson
```
