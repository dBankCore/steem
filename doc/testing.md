...
operation_tests      // Unit Tests of dPay operations
operation_time_tests // Tests of dPay operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_DPAY_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
