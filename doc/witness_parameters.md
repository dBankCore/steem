...
These parameters control various aspects of the operation of the blockchain that are not easily defined in code at compile time. One example is the BEX price feed that defines the conversion rate between BEX and BBD.
...
The exchange rate for BEX/BBD to be used for printing BBD as rewards as well as BBD->BEX conversions.
