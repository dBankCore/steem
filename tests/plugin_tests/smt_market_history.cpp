...
BOOST_AUTO_TEST_CASE( smt_mh_test )
{
   ...
   try
   {
      ...
      BOOST_REQUIRE( bucket->non_dpay.high == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->dpay.low == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.low == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->dpay.open == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.open == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->dpay.close == ASSET( "1.500 TESTS").amount );
      BOOST_REQUIRE( bucket->non_dpay.close == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->dpay.volume == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.volume == asset( 750, any_smt_symbol ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) );
      BOOST_REQUIRE( bucket->dpay.high == ASSET( "0.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->non_dpay.high == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->dpay.low == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.low == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->dpay.open == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.open == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->dpay.close == ASSET( "0.500 TESTS").amount );
      BOOST_REQUIRE( bucket->non_dpay.close == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->dpay.volume == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.volume == asset( 250, any_smt_symbol ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->non_dpay.volume == asset( 500, any_smt_symbol ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->non_dpay.volume == asset( 1500, any_smt_symbol ).amount );
      bucket++;
