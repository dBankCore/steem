...
BOOST_AUTO_TEST_CASE( mh_test )
{
   ...
   try
   {
      ...
      BOOST_REQUIRE( bucket->non_dpay.high == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.low == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.open == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.close == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.volume == ASSET( "0.750 TBD" ).amount );
      ...
      BOOST_REQUIRE( bucket->non_dpay.high == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.low == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.open == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.close == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.volume == ASSET( "0.250 TBD" ).amount );
      ...
      BOOST_REQUIRE( bucket->non_dpay.open == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.close == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.volume == ASSET( "0.500 TBD" ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->non_dpay.open == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.close == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->non_dpay.volume == ASSET( "1.500 TBD" ).amount );
      bucket++;
