...
#include <dpay/market_history/market_history_plugin.hpp>
...
{
   using namespace dpay::market_history;
   ...
   try
   {
      ...
      BOOST_REQUIRE( bucket->high_dpay == ASSET( "1.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_bbd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_dpay == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_bbd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->open_dpay == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->open_bbd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->close_dpay == ASSET( "1.500 TESTS").amount );
      BOOST_REQUIRE( bucket->close_bbd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->dpay_volume == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->bbd_volume == ASSET( "0.750 TBD" ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) );
      BOOST_REQUIRE( bucket->high_dpay == ASSET( "0.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_bbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_dpay == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_bbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->open_dpay == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->open_bbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->close_dpay == ASSET( "0.500 TESTS").amount );
      BOOST_REQUIRE( bucket->close_bbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dpay_volume == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->bbd_volume == ASSET( "0.250 TBD" ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) + 60 );
      BOOST_REQUIRE( bucket->high_dpay == ASSET( "0.450 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_bbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_dpay == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_bbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->open_dpay == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->open_bbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->close_dpay == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->close_bbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dpay_volume == ASSET( "0.950 TESTS" ).amount );
      BOOST_REQUIRE( bucket->bbd_volume == ASSET( "0.500 TBD" ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->close_dpay == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->close_bbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dpay_volume == ASSET( "1.450 TESTS" ).amount );
      BOOST_REQUIRE( bucket->bbd_volume == ASSET( "0.750 TBD" ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->close_dpay == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->close_bbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->dpay_volume == ASSET( "2.950 TESTS" ).amount );
      BOOST_REQUIRE( bucket->bbd_volume == ASSET( "1.500 TBD" ).amount );
      bucket++;
