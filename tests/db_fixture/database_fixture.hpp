...
struct t_smt_database_fixture : public T
{
   ...
   //smt_setup_operation
   smt_generation_unit get_generation_unit ( const units& dpay_unit = units(), const units& token_unit = units() );
   ...
   (
      ...
      const smt_cap_commitment& min_dpay_units_commitment = smt_cap_commitment(),
      const smt_cap_commitment& hard_cap_dpay_units_commitment = smt_cap_commitment(),
