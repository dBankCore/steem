...
function print_help_and_quit {
   ...
   echo "Example: ~/work/dpay/dpay/build/Release/programs/dpayd/dpayd ~/master/dpay/dpay/build/Release/programs/dpayd/dpayd ~/dpay/dpay/work1 ~/dpay/dpay/work2 5000000"
