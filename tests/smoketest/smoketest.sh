...
function print_help_and_quit {
   ...
   echo "Example: ~/work/dpays/dpay/build/Release/programs/dpayd/dpayd ~/master/dpays/dpay/build/Release/programs/dpayd/dpayd ~/dpays/dpay/work1 ~/dpays/dpay/work2 5000000"
