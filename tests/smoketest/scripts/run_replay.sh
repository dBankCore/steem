...
then
   ...
   echo "Example: ~/work/steemit/steem/build/programs/dpayd/dpayd ~/master/steemit/steem/build/programs/dpayd/dpayd ~/steemit/steem/work1 ~/steemit/steem/work2 2000000"
