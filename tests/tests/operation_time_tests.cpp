...
/*BOOST_AUTO_TEST_CASE( comment_payout )
{
   try
   {
      ...
      auto bob_comment_payout = asset( ( ( uint128_t( bob_comment_rshares.value ) * bob_comment_rshares.value * reward_steem.amount.value ) / total_rshares2 ).to_uint64(), BEX_SYMBOL );
      ...
      auto bob_comment_sbd_reward = db->to_sbd( asset( bob_comment_payout.amount / 2, BEX_SYMBOL ) );
...
BOOST_AUTO_TEST_CASE( comment_payout )
{
   try
   {
      ...
      auto bob_comment_sbd_reward = asset( bob_comment_payout.amount / 2, BEX_SYMBOL ) * exchange_rate;
      auto bob_comment_vesting_reward = ( bob_comment_payout - asset( bob_comment_payout.amount / 2, BEX_SYMBOL ) ) * db->get_dynamic_global_properties().get_vesting_share_price();
      ...
      auto alice_comment_sbd_reward = asset( alice_comment_payout.amount / 2, BEX_SYMBOL ) * exchange_rate;
...
BOOST_AUTO_TEST_CASE( nested_comments )
{
   try
   {
      ...
      auto alice_comment_total_payout = db->to_sbd( asset( alice_pays_alice_sbd + alice_pays_alice_vest, BEX_SYMBOL ) );
      alice_comment_total_payout += db->to_sbd( asset( bob_pays_alice_sbd + bob_pays_alice_vest, BEX_SYMBOL ) );
      alice_comment_total_payout += db->to_sbd( asset( dave_pays_alice_sbd + dave_pays_alice_vest, BEX_SYMBOL ) );
      auto bob_comment_total_payout = db->to_sbd( asset( bob_pays_bob_sbd + bob_pays_bob_vest, BEX_SYMBOL ) );
      bob_comment_total_payout += db->to_sbd( asset( dave_pays_bob_sbd + dave_pays_bob_vest, BEX_SYMBOL ) );
      auto sam_comment_total_payout = db->to_sbd( asset( dave_pays_sam_sbd + dave_pays_sam_vest, BEX_SYMBOL ) );
      auto dave_comment_total_payout = db->to_sbd( asset( dave_pays_dave_sbd + dave_pays_dave_vest, BEX_SYMBOL ) );
      ...
      auto alice_total_sbd = alice_starting_sbd + asset( alice_pays_alice_sbd + bob_pays_alice_sbd + dave_pays_alice_sbd, BEX_SYMBOL ) * exchange_rate;
      ...
      auto bob_total_sbd = bob_starting_sbd + asset( bob_pays_bob_sbd + dave_pays_bob_sbd, BEX_SYMBOL ) * exchange_rate;
      ...
      auto sam_total_sbd = sam_starting_sbd + asset( dave_pays_sam_sbd, BEX_SYMBOL ) * exchange_rate;
      ...
      auto dave_total_sbd = dave_starting_sbd + asset( dave_pays_dave_sbd, BEX_SYMBOL ) * exchange_rate;
...
BOOST_AUTO_TEST_CASE( feed_publish_mean )
{
   try
   {
      ...
      for( int i = 0; i < 7; i++ )
      {
         transfer( STEEM_INIT_MINER_NAME, accounts[i], asset( 10000, BEX_SYMBOL ) );
...
BOOST_AUTO_TEST_CASE( steem_inflation )
{
   ...
   /*
      ...
      auto new_rewards = std::max( STEEM_MIN_CONTENT_REWARD, asset( ( STEEM_CONTENT_APR * gpo.virtual_supply.amount ) / ( STEEM_BLOCKS_PER_YEAR * 100 ), BEX_SYMBOL ) )
         + std::max( STEEM_MIN_CURATE_REWARD, asset( ( STEEM_CURATE_APR * gpo.virtual_supply.amount ) / ( STEEM_BLOCKS_PER_YEAR * 100 ), BEX_SYMBOL ) );
      auto witness_pay = std::max( STEEM_MIN_PRODUCER_REWARD, asset( ( STEEM_PRODUCER_APR * gpo.virtual_supply.amount ) / ( STEEM_BLOCKS_PER_YEAR * 100 ), BEX_SYMBOL ) );
      auto witness_pay_shares = asset( 0, VESTS_SYMBOL );
      auto new_vesting_steem = asset( 0, BEX_SYMBOL );
      ...
      while( db->head_block_num() < STEEM_START_VESTING_BLOCK - 1)
      {
         ...
         new_rewards = std::max( STEEM_MIN_CONTENT_REWARD, asset( ( STEEM_CONTENT_APR * gpo.virtual_supply.amount ) / ( STEEM_BLOCKS_PER_YEAR * 100 ), BEX_SYMBOL ) )
            + std::max( STEEM_MIN_CURATE_REWARD, asset( ( STEEM_CURATE_APR * gpo.virtual_supply.amount ) / ( STEEM_BLOCKS_PER_YEAR * 100 ), BEX_SYMBOL ) );
         witness_pay = std::max( STEEM_MIN_PRODUCER_REWARD, asset( ( STEEM_PRODUCER_APR * gpo.virtual_supply.amount ) / ( STEEM_BLOCKS_PER_YEAR * 100 ), BEX_SYMBOL ) );
         new_vesting_steem = asset( 0, BEX_SYMBOL );
      ...
      while( db->head_block_num() < STEEM_START_MINER_VOTING_BLOCK - 1 )
      {
         ...
         witness_pay = std::max( STEEM_MIN_PRODUCER_REWARD, asset( ( STEEM_PRODUCER_APR * gpo.virtual_supply.amount ) / ( STEEM_BLOCKS_PER_YEAR * 100 ), BEX_SYMBOL ) );
         auto witness_pay_shares = asset( 0, VESTS_SYMBOL );
         new_vesting_steem = asset( ( witness_pay + new_rewards ).amount * 9, BEX_SYMBOL );
         new_vesting_shares = gpo.total_vesting_shares;
      ...
      for( int i = 0; i < STEEM_BLOCKS_PER_DAY; i++ )
      {
         ...
         witness_pay = std::max( STEEM_MIN_PRODUCER_REWARD, asset( ( STEEM_PRODUCER_APR * gpo.virtual_supply.amount ) / ( STEEM_BLOCKS_PER_YEAR * 100 ), BEX_SYMBOL ) );
         witness_pay_shares = witness_pay * gpo.get_vesting_share_price();
         new_vesting_steem = asset( ( witness_pay + new_rewards ).amount * 9, BEX_SYMBOL ) + witness_pay;
      ...
      BOOST_REQUIRE_EQUAL( db->get_account( witness_name ).vesting_shares.amount.value,
         old_witness_shares.amount.value + ( asset( ( ( virtual_supply.amount.value / STEEM_BLOCKS_PER_YEAR ) * STEEM_1_PERCENT ) / STEEM_100_PERCENT, BEX_SYMBOL ) * ( vesting_shares / vesting_steem ) ).amount.value );
      validate_database();
      */
   }
   FC_LOG_AND_RETHROW();
...
BOOST_AUTO_TEST_CASE( liquidity_rewards )
{
   ...
   try
   {
      ...
      op.owner = "alice";
      op.amount_to_sell = asset( alice_sbd.amount.value / 20, BBD_SYMBOL ) ;
      ...
      alice_steem_volume += ( asset( alice_sbd.amount / 20, BBD_SYMBOL ) * exchange_rate ).amount.value;
      alice_reward_last_update = db->head_block_time();
      bob_steem_volume -= ( asset( alice_sbd.amount / 20, BBD_SYMBOL ) * exchange_rate ).amount.value;
      ...
      BOOST_REQUIRE( fill_order_op.open_pays.amount.value == asset( alice_sbd.amount.value / 20, BBD_SYMBOL ).amount.value );
      BOOST_REQUIRE( fill_order_op.current_owner == "bob" );
      BOOST_REQUIRE( fill_order_op.current_orderid == 2 );
      BOOST_REQUIRE( fill_order_op.current_pays.amount.value == ( asset( alice_sbd.amount.value / 20, BBD_SYMBOL ) * exchange_rate ).amount.value );
      ...
      op.owner = "sam";
      op.amount_to_sell = asset( ( alice_sbd.amount.value / 20 ), BEX_SYMBOL );
      op.min_to_receive = asset( ( alice_sbd.amount.value / 20 ), BBD_SYMBOL );
      op.orderid = 3;
      ...
      op.owner = "bob";
      op.orderid = 4;
      op.amount_to_sell = asset( ( alice_sbd.amount.value / 10 ) * 3 - alice_sbd.amount.value / 20, BEX_SYMBOL );
      op.min_to_receive = asset( ( alice_sbd.amount.value / 10 ) * 3 - alice_sbd.amount.value / 20, BBD_SYMBOL );
      ...
      op.owner = "alice";
      op.orderid = 5;
      op.amount_to_sell = asset( ( alice_sbd.amount.value / 10 ) * 3, BBD_SYMBOL );
      op.min_to_receive = asset( ( alice_sbd.amount.value / 10 ) * 3, BEX_SYMBOL );
      ...
      BOOST_REQUIRE( fill_order_op.open_pays.amount.value == asset( ( alice_sbd.amount.value / 10 ) * 3 - alice_sbd.amount.value / 20, BEX_SYMBOL ).amount.value );
      BOOST_REQUIRE( fill_order_op.current_owner == "alice" );
      BOOST_REQUIRE( fill_order_op.current_orderid == 5 );
      BOOST_REQUIRE( fill_order_op.current_pays.amount.value == asset( ( alice_sbd.amount.value / 10 ) * 3 - alice_sbd.amount.value / 20, BBD_SYMBOL ).amount.value );
      ...
      BOOST_REQUIRE( fill_order_op.open_pays.amount.value == asset( alice_sbd.amount.value / 20, BEX_SYMBOL ).amount.value );
      BOOST_REQUIRE( fill_order_op.current_owner == "alice" );
      BOOST_REQUIRE( fill_order_op.current_orderid == 5 );
      BOOST_REQUIRE( fill_order_op.current_pays.amount.value == asset( alice_sbd.amount.value / 20, BBD_SYMBOL ).amount.value );
      ...
      op.orderid = 6;
      op.amount_to_sell = asset( alice_sbd.amount.value / 20 * 2, BBD_SYMBOL );
      op.min_to_receive = asset( alice_sbd.amount.value / 20 * 2, BEX_SYMBOL );
      ...
      BOOST_REQUIRE( fill_order_op.current_pays.amount.value == asset( alice_sbd.amount.value / 20, BEX_SYMBOL ).amount.value );
      ...
      transfer.to = "dave";
      transfer.from = "alice";
      transfer.amount = asset( alice_sbd.amount / 2, BBD_SYMBOL );
      ...
      op.owner = "alice";
      op.amount_to_sell = asset( 8 * ( alice_sbd.amount.value / 20 ), BEX_SYMBOL );
      ...
      op.owner = "dave";
      op.amount_to_sell = asset( 7 * ( alice_sbd.amount.value / 20 ), BBD_SYMBOL );;
      ...
      transfer.to = "bob";
      transfer.from = "alice";
      transfer.amount = asset( alice_sbd.amount / 5, BBD_SYMBOL );
      tx.operations.clear();
      tx.signatures.clear();
      tx.operations.push_back( transfer );
      tx.set_expiration( db->head_block_time() + STEEM_MAX_TIME_UNTIL_EXPIRATION );
      ...
      op.owner = "bob";
      op.orderid = 12;
      op.amount_to_sell = asset( 3 * ( alice_sbd.amount / 40 ), BBD_SYMBOL );
      op.min_to_receive = asset( op.amount_to_sell.amount, BEX_SYMBOL );
      tx.operations.clear();
      tx.signatures.clear();
      tx.operations.push_back( op );
...
BOOST_AUTO_TEST_CASE( sbd_stability )
{
   try
   {
      ...
      asset sbd_balance = asset( ( gpo.virtual_supply.amount * ( gpo.sbd_stop_percent + 112 ) ) / STEEM_100_PERCENT, BEX_SYMBOL ) * exchange_rate;
      ...
      auto alice_sbd = db->get_account( "alice" ).sbd_balance + db->get_account( "alice" ).reward_sbd_balance + asset( sbd_reward, BEX_SYMBOL ) * exchange_rate;
      ...
      db_plugin->debug_update( [=]( database& db )
      {
         db.modify( db.get_account( "sam" ), [&]( account_object& a )
         {
            a.sbd_balance = asset( ( ( gpo.sbd_start_percent - 6 ) * sbd_balance.amount ) / gpo.sbd_stop_percent, BBD_SYMBOL );
         });
      }, database::skip_witness_signature );
      ...
      db_plugin->debug_update( [=]( database& db )
      {
         db.modify( db.get_dynamic_global_properties(), [&]( dynamic_global_property_object& gpo )
         {
            gpo.current_sbd_supply = alice_sbd + asset( ( ( gpo.sbd_start_percent - 6 ) * sbd_balance.amount ) / gpo.sbd_stop_percent, BBD_SYMBOL );
         });
      }, database::skip_witness_signature );
...
BOOST_AUTO_TEST_CASE( sbd_price_feed_limit )
{
   try
   {
      ...
      auto new_exchange_rate = price( gpo.current_sbd_supply, asset( ( STEEM_100_PERCENT ) * gpo.current_supply.amount, BEX_SYMBOL ) );
