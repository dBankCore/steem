...
BOOST_AUTO_TEST_CASE( smt_liquidity_rewards )
{
   ...
   try
   {
      ...
      op.owner = "sam";
      op.amount_to_sell = asset( ( alice_smt.amount.value / 20 ), BEX_SYMBOL );
      ...
      op.owner = "bob";
      op.orderid = 4;
      op.amount_to_sell = asset( ( alice_smt.amount.value / 10 ) * 3 - alice_smt.amount.value / 20, BEX_SYMBOL );
      ...
      op.min_to_receive = asset( ( alice_smt.amount.value / 10 ) * 3, BEX_SYMBOL );
      ...
      BOOST_REQUIRE( fill_order_op.open_pays.amount.value == asset( ( alice_smt.amount.value / 10 ) * 3 - alice_smt.amount.value / 20, BEX_SYMBOL ).amount.value );
      ...
      BOOST_REQUIRE( fill_order_op.open_pays.amount.value == asset( alice_smt.amount.value / 20, BEX_SYMBOL ).amount.value );
      BOOST_REQUIRE( fill_order_op.current_owner == "alice" );
      BOOST_REQUIRE( fill_order_op.current_orderid == 5 );
      ...
      op.min_to_receive = asset( alice_smt.amount.value / 20 * 2, BEX_SYMBOL );
      ...
      BOOST_REQUIRE( fill_order_op.current_pays.amount.value == asset( alice_smt.amount.value / 20, BEX_SYMBOL ).amount.value );
      ...
      op.owner = "alice";
      op.amount_to_sell = asset( 8 * ( alice_smt.amount.value / 20 ), BEX_SYMBOL );
