...
namespace dpay { namespace example_plugin {

class hello_api_plugin : public dpay::app::plugin
{
   public:
      /**
       ...
       */
      hello_api_plugin( dpay::app::application* app );
...
{
   public:
      hello_api_api( const dpay::app::api_context& ctx );
...
FC_API( dpay::example_plugin::hello_api_api,
   (get_message)
   )

namespace dpay { namespace example_plugin {

hello_api_plugin::hello_api_plugin( dpay::app::application* app ) : dpay::app::plugin(app) {}
...
hello_api_api::hello_api_api( const dpay::app::api_context& ctx ) : _app(ctx.app) {}
...
/**
 * The DPAY_DEFINE_PLUGIN() macro will define a dpay::plugin::create_hello_api_plugin()
 * factory method which is expected by the manifest.
 */

DPAY_DEFINE_PLUGIN( hello_api, dpay::example_plugin::hello_api_plugin )
